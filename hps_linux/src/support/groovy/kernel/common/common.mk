...
CFLAGS += -I$(LIB_DIR)/libbpf -I$(LIB_DIR)/libxdp -I$(LIB_DIR)/install/include $(EXTRA_CFLAGS) -I/opt/arm/arm-none-linux-gnueabihf/libc/usr/include
BPF_CFLAGS += -I$(LIB_DIR)/libxdp -I$(LIB_DIR)/libbpf -I/opt/arm/arm-none-linux-gnueabihf/libc/usr/include -I$(LIB_DIR)/install/include $(EXTRA_CFLAGS)
LDFLAGS += -L$(LIB_DIR)/install/lib -L/opt/arm/arm-none-linux-gnueabihf/libc/lib -L/opt/arm/arm-none-linux-gnueabihf/lib -L$(LIB_DIR)/zlib -lz -L$(LIB_DIR)/libelf -lelf -L$(LIB_DIR)/libbpf -lbpf -L$(LIB_DIR)/libxdp -lxdp
...
$(XDP_OBJ): %.o: %.c  Makefile $(COMMON_MK) $(KERN_USER_H) $(EXTRA_DEPS) $(OBJECT_LIBBPF)
	$(QUIET_CLANG)$(CLANG) -S \
	    -target arm-v7a-unknown-linux-gnueabihf \
            --sysroot=/opt/arm/arm-none-linux-gnueabihf \
	    -D __BPF_TRACING__ \
	    $(BPF_CFLAGS) \
	    -Wall \
	    -Wno-unused-value \
