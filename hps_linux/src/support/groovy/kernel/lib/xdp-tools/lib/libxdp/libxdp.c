...
#define BPF_DIR_MNT "../libbpf"
#define BPF_OBJECT_PATH "../libbpf"
#define RUNDIR "."
#define HAVE_LIBBPF_BPF_XDP_ATTACH 1
...
#define HAVE_LIBBPF_BTF__LOAD_FROM_KERNEL_BY_ID 1
...
#define HAVE_LIBBPF_BTF__TYPE_CNT 1
...
#define HAVE_LIBBPF_BPF_OBJECT__NEXT_MAP 1
...
#define HAVE_LIBBPF_BPF_OBJECT__NEXT_PROGRAM 1
...
#define HAVE_LIBBPF_BPF_PROGRAM__INSN_CNT 1
...
#define HAVE_LIBBPF_BPF_PROGRAM__TYPE 1
...
#define HAVE_LIBBPF_BPF_PROGRAM__FLAGS 1
